...
var connectionsListRef = database.ref('/connectionList');
...
connectedRef.on('value', function(snapshot){
  if(snapshot.val()){
    // this happens when connected
    var connection = connectionsListRef.push(true);
...
connectionsListRef.on("value", function(snapshot){
  // get you the number users and add it to the page
