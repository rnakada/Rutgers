...
* [6.2 - API_AJAX](../Slideshow/API_AJAX.pptx)

### Key Activities

* [6.1 - Button Triggered AJAX](../01-Activities/03-AJAX_to_HTML)
* [6.1 - Giphy API](../01-Activities/04-Giphy_API)
* [6.2 - Working OMDb Movie App](../01-Activities/10-WorkingMovieApp)
* [6.3 - Dynamic Elements](../01-Activities/14-DynamicElements)
* [6.3 - Pausing Gifs](../01-Activities/15-PausingGifs)
* [6.3 - NYT Search Application](../01-Activities/16-NYTSearch)
